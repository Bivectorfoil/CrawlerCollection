...
'''One small script to crawl the jokes(in the form of text) from
...
def crawl_joke_list_bs4(page=1):
    ...
    for child in joke_list:
        ...
        joke_content = ''.join(
            child.find(
                'div',
                class_='content').stripped_strings)  # remove extra spaces
...
if __name__ == '__main__':
    ...
    continue_read = raw_input(
        'would you like to read the jokes we have just crawled? (y(Enter)/n)')
